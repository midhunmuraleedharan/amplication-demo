...
describe("LanguageDemo", () => {
  ...
  test("GET /languageDemos/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/languageDemos"}/${nonExistingId}`)
  ...
  test("GET /languageDemos/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/languageDemos"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
