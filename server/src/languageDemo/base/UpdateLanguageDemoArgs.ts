...
@ArgsType()
class UpdateLanguageDemoArgs {
  @Field(() => LanguageDemoWhereUniqueInput, { nullable: false })
  where!: LanguageDemoWhereUniqueInput;
  @Field(() => LanguageDemoUpdateInput, { nullable: false })
  data!: LanguageDemoUpdateInput;
}

export { UpdateLanguageDemoArgs };
